...
x_FL_Nominal=[32/nominalBandwidth,GFLOPsnominal/nominalBandwidth,1E4];
y_FL_Nominal=[32,GFLOPsnominal,GFLOPsnominal];
...
legend({'WENO5$_Z$ $\mathbf{\mathit{f}}_x$','WENO5$_Z$ $\mathbf{\mathit{g}}_y$','WENO5$_Z$ $\mathbf{\mathit{h}}_z$','WENO7$_Z$ $\mathbf{\mathit{f}}_x$','WENO7$_Z$ $\mathbf{\mathit{g}}_y$','WENO7$_Z$ $\mathbf{\mathit{h}}_z$','Laplacian $\mathbf{\nabla}^2$','RK step (avg.)'},'Location','Eastoutside','Interpreter','Latex');
legend boxoff
