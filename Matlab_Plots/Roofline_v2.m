...
loglog(x_kernelf(3),y_Kernelf(3),'o','Color',black); hold on
loglog(x_kernelg(3),y_Kernelg(3),'s','Color',black);
loglog(x_kernelh(3),y_Kernelh(3),'d','Color',black);
...
loglog(x_kernelL(3),y_KernelL(3),'^','Color',black);
loglog(x_kernelL(2),y_KernelL(2),'^','Color',orange);
loglog(x_kernelL(1),y_KernelL(1),'^','Color',yellow);
loglog(x_kernelRK(2),y_KernelRK(2),'*','Color',black);
loglog(x_kernelRK(1),y_KernelRK(1),'*','Color',orange);
loglog(x_kernelCODE(1),y_KernelCODE(1),'p','Color',blue);
